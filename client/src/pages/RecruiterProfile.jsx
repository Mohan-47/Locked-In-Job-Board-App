    ...
    <div className="min-h-screen">
      ...
      <div className="flex">
        ...
        <main className="flex-1 flex justify-center items-start p-2">
          <div className="w-full flex flex-col lg:flex-row gap-2 lg:h-[calc(100vh-90px)]">
            {/* Profile Section */}
              ...
              >
                ...
                <ul className="space-y-4">
                  {js.map((app) => (
                    <li key={app._id}>
                      <Link
                        to={`/recruiter/job/${app._id}/manage`}
                      ...
                      >
                        <div className="text-2xl flex-shrink-0">
                          <FaBriefcase className="text-teal-400 transition-transform duration-300 group-hover:rotate-6 group-hover:scale-110" />
                        </div>
                        <div className="flex-col flex-1">
                          ...
                          <div className="text-xs text-zinc-400 line-clamp-1">
                            {app.companyName} • {app.type} • {app.location}
                          </div>
